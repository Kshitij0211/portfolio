  ...
  return (
    <div className="drawer z-[9999] sticky top-0 opacity-95">
      ...
      <div className="drawer-content flex flex-col">
        <div className="navbar bg-base-300 w-full justify-between">
          ...
          <div className="navbar-end gap-x-4 lg:w-auto">
            ...
            <a
              href="/"
              className="btn btn-outline border-primary text-sm md:text-xl md:px-10 text-primary rounded hover:border-primary hover:text-white hover:bg-primary"
      ...
      <div className="drawer-side">
        ...
        ></label>
        <ul
          className="menu bg-base-200 min-h-full w-80 text-2xl p-4"
