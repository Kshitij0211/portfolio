...
const Navbar = () => {
    ...
    return (
        <div className="drawer z-[9999] sticky top-0 opacity-95">
            <input id="my-drawer-3" type="checkbox" className="drawer-toggle" checked={drawer} onChange={() => setDrawer(true)}/>
                ...
                <div className="navbar bg-base-300 w-full justify-between">
                    <div className="navbar-start lg:w-auto">
                        ...
                        <div onClick={() => {
                            ...
                            <span className="capitalize first-letter:text-3xl text-2xl">KSHITIJ RAJ</span>
                        </div>
                    </div>
                    ...
                    <div className="navbar-end gap-x-4 lg:w-auto">
                        ...
                        <a href="/" className="btn btn-outline border-primary text-sm md:text-xl md:px-10 text-primary rounded hover:border-primary hover:text-white hover:bg-primary">
                            Lets Connect
                        </a>
                    </div>
                </div>
            ...
            <div className="drawer-side">
                ...
                <ul className="menu bg-base-200 min-h-full w-80 text-2xl p-4" onClick={() => setDrawer(false)}>
                    <li><a href="#home">Home</a></li>
                    <li><a href="#portfolio">Portfolio</a></li>
                    <li><a href="#about">Work</a></li>
                    <li><a href="#contact">Contact</a></li>
