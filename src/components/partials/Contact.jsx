...
const Contact = () => {
    ...
    const handleDownloadResume = () => {
        ...
        link.href = pdfUrl;
        link.download = "Kshitij_Raj_Business_Analyst.pdf";
    ...
    return (
        <div className="w-full flex flex-col items-center" id="contact">
            <footer className="footer bg-neutral text-neutral-content p-10 items-end">
                <aside>
                    <svg
                        width="50"
                        height="50"
                ...
                <nav className="flex lg:flex-row lg:items-end justify-around w-full flex-col items-start gap-y-4">
                    ...
                    <div className="btn text-lg btn-success" onClick={handleDownloadResume}>
                        Download Resume
